...
var MD5 = function (string) {
	...
	function AddUnsigned (lX, lY) {
		var lX4, lY4, lX8, lY8, lhash;
		lX8 = (lX & 0x80000000);
		lY8 = (lY & 0x80000000);
		lX4 = (lX & 0x40000000);
		lY4 = (lY & 0x40000000);
		lhash = (lX & 0x3FFFFFFF) + (lY & 0x3FFFFFFF);
		if (lX4 & lY4) {
			return (lhash ^ 0x80000000 ^ lX8 ^ lY8);
		}
		if (lX4 | lY4) {
			if (lhash & 0x40000000) {
				return (lhash ^ 0xC0000000 ^ lX8 ^ lY8);
			} else {
				return (lhash ^ 0x40000000 ^ lX8 ^ lY8);
			}
		} else {
			return (lhash ^ lX8 ^ lY8);
		}
	}
